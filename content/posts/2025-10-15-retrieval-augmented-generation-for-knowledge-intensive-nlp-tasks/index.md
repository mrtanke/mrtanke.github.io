...
date: 2025-10-15 09:43:53+00:00
draft: false
description: 'Paper-reading notes: Retrieval-Augmented Generation for Knowledge-Intensive
  NLP Tasks'
ShowWordCount: true
...
![“Ablation” means **removing or changing a part of the model to test how much it matters**.](image_7.png)
...
![The heatmap (right) shows **which retrieved document (y-axis)** the model relies on when generating **each token (x-axis)** of a sentence.](image_8.png)
